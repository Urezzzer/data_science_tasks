...
def corpus_edits(wiki_xml, file):
    args = parse_user_args(wiki_xml, file)
...
def parse_user_args(wiki_xml, file):
    ...
    group.add_argument("-l", "--language", default="russian",
...
if __name__ == "__main__":
    corpus_edits('rus-20210409024318.xml', 'edits.txt')
